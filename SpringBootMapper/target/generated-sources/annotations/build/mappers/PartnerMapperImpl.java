...
public class PartnerMapperImpl implements PartnerMapper {
    ...
    public PartnerDTO partnerToDTO(Partner entity, PartnerSource source, Country country) {
        ...
        if ( entity != null ) {
            partnerDTO.setNationality( PartnerMapper.getNationality( entity.getNationality() ) );
            partnerDTO.set_id( toObjectId( entity.get_id() ) );
            partnerDTO.setState( PartnerMapper.getState( entity.getState() ) );
            ...
            partnerDTO.setCountry( PartnerMapper.getCountry( entity.getCountry(), country ) );
